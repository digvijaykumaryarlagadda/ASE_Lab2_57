...
public class WeatherFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        updateWeatherData(new PreferenceCity(getActivity()).getCity());
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        currentTemperatureField = (TextView) rootView.findViewById(R.id.realtime_temperature_field);
        weatherIcon = (TextView) rootView.findViewById(R.id.weather_forecast_icon);
    ...
    private void updateWeatherData(final String city) {
        new Thread() {
            @Override
            public void run() {
                final JSONObject json = FetchRm.getJSON(getActivity(), city);
                if(json == null) {
